...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"scripts/alluvial.js":[function(require,module,exports) {
var dataset = [{
  Airline: "Airline A",
  Duration: "short",
...
dataset.forEach(function (d) {
  var sourceIndex = graph.nodes.findIndex(function (node) {
    return node.name === d.Airline;
  });
  var targetIndex = graph.nodes.findIndex(function (node) {
    return node.name === d.Duration;
  });
  var sourceNode = {
    name: d.Airline
  };
...
link.append("path").attr("d", d3.sankeyLinkHorizontal()).attr("stroke-width", function (d) {
  return Math.max(1, d.width);
});
link.append("title").text(function (d) {
  return "".concat(d.source.name, " \u2192 ").concat(d.target.name, "\n").concat(d3.format(",.0f")(d.value));
});
...
},{}]},{},["../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","scripts/alluvial.js"], null)
//# sourceMappingURL=/alluvial.ceaccd3c.js.map